  ...
  return (
    <div className="relative z-10 w-full pt-32 md:pt-40 pb-24">
      <div className="w-full max-w-3xl mx-auto px-6 md:px-10">
        ...
        {/* Title */}
        <h1 
          className={`text-4xl md:text-5xl font-light text-white mb-8 tracking-tight transition-all duration-1000 delay-200 ${
        ...
        {/* Intro - Highlighted */}
        <div 
          className={`mb-16 p-6 md:p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-primary/30 transition-all duration-1000 delay-300 ${
            visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'
          }`}
        >
